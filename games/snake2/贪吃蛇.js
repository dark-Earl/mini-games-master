...
document.onkeydown = keydown;
    function keydown(){
        ...
        if (e.key == 'ArrowLeft'  && game_over_val === 1) {
        ...
        } else if (e.key == 'ArrowUp'  && game_over_val === 1) {
            if (coordinate_X.length === 1) {
                direction = "up"
            } else {
        ...
        } else if (e.key == 'ArrowRight'  && game_over_val === 1) {
            if (coordinate_X.length === 1) {
                direction = "before"
            } else {
        ...
        } else if (e.key == 'ArrowDown'  && game_over_val === 1) {
            if (coordinate_X.length === 1) {
                direction = "down"
            } else {
